...
# 订单类型
ORDER_TYPE_MKT = 'MKT'  # 市价单
ORDER_TYPE_LMT = 'LMT'  # 限价单
...
# 订单状态
ORDER_STATUS_NONE = 0  # 新创建的订单，无状态
ORDER_STATUS_SUBMITTED = 1  # 已提交
ORDER_STATUS_PARTDEAL = 2  # 部分处理
ORDER_STATUS_DEAL = 3  # 处理
ORDER_STATUS_CANCEL = 4  # 取消
ORDER_STATUS_FAILED = 5  # 失败订单
...
class Order:
    ...
    def __init__(self, platform=None, account=None, strategy=None, order_no=None, symbol=None, action=None, price=0,
                 quantity=0, order_type=ORDER_TYPE_LMT):
